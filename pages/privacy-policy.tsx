...
import { INFO_EMAIL, PROJECT_NAME, SITE_ABOUT, logo, server } from '../config';
...
const Page: NextPageWithLayout<IPageProps> = ({
  ...
  //TODO: add GDPR, CCPA/CPRA clauses, termsfeed.com wont include it for free, :)

  return (
    <section className="p-16">
      <h1 className="my-page-title">Privacy Policy</h1>
      {/* ***************************https://www.termsfeed.com/live/08385f45-01e0-44b6-a21f-bb53514fffc8*********************************************** */}
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to {PROJECT_NAME} LLC.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to {PROJECT_NAME}, accessible from{' '}
            <a
              className="my-link-underline"
              href={server}
